...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.fadeSecForClickNoise = exports.operatorCount = void 0;\nexports.convertOperatorParamsToEx = convertOperatorParamsToEx;\nexports.operatorCount = 6;\nexports.fadeSecForClickNoise = 0.001;\nfunction convertOperatorParamsToEx(params) {\n    return Object.assign(Object.assign({}, params), { ampEnvelope: Object.assign(Object.assign({}, params.ampEnvelope), { attackSec: Math.max(params.ampEnvelope.attackSec, exports.fadeSecForClickNoise), releaseSec: Math.max(params.ampEnvelope.releaseSec, exports.fadeSecForClickNoise) }), sleep: params.sendDepths.every(d => d == 0) && params.volume == 0 });\n}\n\n\n//# sourceURL=webpack://websynthtest01/./src/synth/operatorParams.ts?");
